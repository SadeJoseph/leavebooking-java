...
public record StaffMemberDTO(String id, String firstName, String surname, String emailAddress, String department) {
  ...
  public static final String DEPARTMENT_BLANK = "A department is required";
  ...
  public StaffMemberDTO {
    ...
    if (department == null || department.isBlank()) {
      throw new IllegalArgumentException(DEPARTMENT_BLANK);
    }
  }
}