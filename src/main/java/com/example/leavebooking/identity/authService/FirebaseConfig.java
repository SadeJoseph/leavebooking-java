  ...
  public JwtDecoder jwtDecoder(
    ...
    if (projectId == null || projectId.isBlank()) {
      throw new IllegalStateException(
          SERVICE_ACCOUNT_DOES_NOT_CONTAIN_VALID_PROJECT_ID);
    }

    String jwkSetUri = "https://www.googleapis.com/service_accounts/v1/jwk/"
    ...
    String issuerUri = "https://securetoken.google.com/"
        + projectId;

    // Confirms the token came from our Firebase project.
    OAuth2TokenValidator<Jwt> withIssuer = JwtValidators.createDefaultWithIssuer(
        issuerUri);

    // Confirms the token was intended for our project.
    OAuth2TokenValidator<Jwt> withAudience = new JwtClaimValidator<List<String>>(
        "aud",
        audList -> audList != null
            && audList.contains(projectId));
