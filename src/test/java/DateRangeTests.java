...
public class DateRangeTests {
	...
	void test01() {
		assertDoesNotThrow(() -> new DateRange(
	...
	void test05() {
		...
		assertDoesNotThrow(() -> new DateRange(date, date));
	}
	...
	@Test
	@DisplayName("A Monday to Friday date range contains five working days")
	void testWorkingDaysMondayToFriday() {

		DateRange dateRange = new DateRange(
				LocalDate.of(2026, 10, 12),
				LocalDate.of(2026, 10, 16));

		assertEquals(5, dateRange.numberOfDays());
	}

	@Test
	@DisplayName("Weekend days are not counted as working days")
	void testWorkingDaysExcludeWeekend() {
		...
		assertEquals(2, dateRange.numberOfDays());
	}

	@Test
	@DisplayName("A single working day counts as one day")
